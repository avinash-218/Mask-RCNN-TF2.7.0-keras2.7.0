...
class Dataset(object):
    ...
    def load_image(self, image_id):
        ...
        # print("image read", image.shape) #(2138, 2171)
        image = np.expand_dims(image, axis=-1)
        # print("image expanded", image.shape) #(2138, 2171, 1)
        return image
...
def compute_precision_recall_f1(pred_boxes, gt_boxes, iou_threshold=0.5):
    ...
    recall, positive_ids = compute_recall(pred_boxes, gt_boxes, iou_threshold)
